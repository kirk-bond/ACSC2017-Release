...
#
# template by Erik Hunstad - 14 APR 16
#
###

# User vars
CHALLENGE_NAME="sql_foo"
PASSWORD="sql"
SSH_BANNER_TEXT="SQL Foo - Python"
...
echo -e "#!/bin/bash\ndocker run -it --rm --network=none --user=user -w /home/user $CHALLENGE_NAME" > /usr/local/bin/$SHELL_NAME
